...
- **Deep Learning:** PyTorch (basic), CNNs for image classification
- **Model Deployment:** Streamlit, Flask
- **Tools:** Git, GitHub, Jupyter Notebook, VS Code
- **Domains:** Healthcare analytics, Predictive maintenance, Resume classification, Price prediction
...
- Includes a **training notebook**, model artifacts, and a **deployment-ready app (`app.py`)**.  
- Packaged with `requirements.txt` so it can be easily reproduced and deployed.
...
- Trained regression models and evaluated performance using metrics stored in the `artifacts/` folder.  
- Contains a **Streamlit/Flask-style app script** (`app.py`) to make the model interactive for end users.
...
- Experimented with multiple CNN architectures like **EfficientNet, ResNet, DenseNet, MobileNet**, and saved the best-performing models.  
- Includes training notebooks, inference scripts, and example leaf images.
...
- Includes dataset, deployment files, and a demo video showing the app in action.  
- Designed to help automate **screening of candidate resumes** based on content.
...
- Covers **data preprocessing, feature engineering, model training**, and deployment via a simple app.  
- Includes saved models (`rf_model.pkl`, `scaler.pkl`) and a Jupyter Notebook walkthrough.
...
- [laptop_price_prediction](https://github.com/Hritik827/laptop_price_prediction) – Machine learning model to estimate laptop prices from specs. :contentReference[oaicite:5]{index=5}  
- [Python_Fundamental_practice](https://github.com/Hritik827/Python_Fundamental_practice) – Core Python practice scripts. :contentReference[oaicite:6]{index=6}  
...
- **Model deployment** using Streamlit and building clean, user-friendly interfaces  
- Exploring **bioinformatics and metagenomics** as emerging application areas
